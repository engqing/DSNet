...
def get_args():
    ...
    parser.add_argument(
        '--config', 
        type=str,
        default='./cfgs/PCN_models/DSNetplus.yaml',
    ...
    # some args
    parser.add_argument('--exp_name', type=str, default='vis_feature', help='experiment name')
    parser.add_argument('--start_ckpts', type=str, default=None, help='reload used ckpt path')
    parser.add_argument('--ckpts', type=str, default='./experiments/DSNetplus/PCN_models/vis_feature/ckpt-best.pth', help='test used ckpt path')
